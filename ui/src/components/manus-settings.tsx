...
import type { AgentConfig, LLMConfig, ListA2AServerItem, ListMCPServerItem } from '@/lib/api'
import { configApi } from '@/lib/api'
import { Languages, LayoutGrid, LayoutList, Loader2, Settings, Trash, Wrench } from 'lucide-react'
        ...
        <FieldSet>
          ...
          <FieldGroup>
            ...
            <Field>
              ...
              />
              <FieldDescription className="text-xs">
                请填写 MiniManus 调用的模型名字，模型必须支持工具调用、图像识别等功能。
              </FieldDescription>
            </Field>
            <Field>
      ...
      <FieldGroup>
        <FieldSet>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="text-gray-500">
                    MiniManus 使用标准的 A2A 协议来连接远程 Agent。
                    <br/>
                    ...
                    <FieldSet>
                      <Field>
                        <Input
                          id="a2a_base_url"
                          type="url"
                          placeholder="Example: https://mini-manus.com/weather-agent"
                          value={addUrl}
          ...
          <FieldDescription className="text-sm">
            模型上下文协议 (MCP) 通过集成外部工具来增强 MiniManus 的性能，例如私有域搜索、网页浏览、订餐、PPT 生成等任务。
          </FieldDescription>
            ...
            <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="text-gray-500">
                    MiniManus 使用标准的 JSON MCP 配置来创建新服务器。
