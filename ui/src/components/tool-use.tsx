        ...
        <>
            ...
            <div className="flex items-center group gap-2 cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                    <div className="rounded-[15px] inline-flex items-center gap-2 px-2.5 border bg-gray-100 max-w-full clickbale">
                        {/* 图表信息 */}
                        ...
                        <div className="flex-1 h-full min-w-0 flex">
                            <div className="inline-flex items-center h-full rounded-full text-xs text-gray-700 max-w-full">
                                <div className="flex items-center justify-center">
                                    正在写入文件
                                    <span
                                        className="flex-1 min-w-0 rounded-[6px] ml-1 relative top-0 text-xs font-mono max-w-full text-ellipsis overflow-hidden whitespace-nowrap text-gray-500"
                                    >
